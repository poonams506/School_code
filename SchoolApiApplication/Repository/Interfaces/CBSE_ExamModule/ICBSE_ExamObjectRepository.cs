...
namespace SchoolApiApplication.Repository.Interfaces.CBSE_ExamModule
{
    public interface ICBSE_ExamObjectRepository
    {
     ...
     public Task<int> PublishUnpublishExamObjectParticular(PublishUnpublishExamObjectDto publishRequest, int UserId);
        ...
        //public Task<ExamObjectDeleteResponseDto> CBSE_ObjectDelete(long ExamObjectId, long ExamMasterId, long SubjectMasterId, int AcademicYearId, int UserId);
