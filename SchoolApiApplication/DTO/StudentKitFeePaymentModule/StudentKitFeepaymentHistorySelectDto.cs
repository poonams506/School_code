...
{
    public class StudentKitFeepaymentHistorySelectDto
    {
        ...
        public List<StudentKitFeeParticularsSelectDto> StudentKitFeeParticularsSelectList { get; set; } = new List<StudentKitFeeParticularsSelectDto>();
    }

    public class StudentKitFeeParticularsSelectDto
    {
