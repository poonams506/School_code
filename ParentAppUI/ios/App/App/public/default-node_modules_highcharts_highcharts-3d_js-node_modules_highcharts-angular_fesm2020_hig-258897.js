(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["default-node_modules_highcharts_highcharts-3d_js-node_modules_highcharts-angular_fesm2020_hig-258897"],{
...
*/
function (t) {
   true && module.exports ? (t.default = t, module.exports = t) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! highcharts */ 77859)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (e) {
  ...
  i(e, "Core/Math3D.js", [e["Core/Globals.js"], e["Core/Utilities.js"]], function (t, e) {
    ...
    return {
      compose: function (t) {
        r(i, "Axis.Tick3D") && (s(t, "afterGetLabelPosition", n), a(t.prototype, "getMarkPath", l));
      }
    };
    ...
    function f() {
      let t = this.chart,
        e = this.options;
      t.is3d && t.is3d() && "colorAxis" !== this.coll && (e.tickWidth = x(e.tickWidth, 0), e.gridLineWidth = x(e.gridLineWidth, 1));
    }
    function u(t) {
    ...
    function m(t) {
      ...
      return "M" === n[0] && "L" === h[0] && (p = [e.swapZ({
        ...
        y: h[2],
        z: r
      })], this.horiz ? (this.isZAxis ? (a.left.visible && c.push(p[0], p[2]), a.right.visible && c.push(p[1], p[3])) : (a.front.visible && c.push(p[0], p[2]), a.back.visible && c.push(p[1], p[3])), a.top.visible && c.push(p[0], p[1]), a.bottom.visible && c.push(p[2], p[3])) : (a.front.visible && c.push(p[0], p[2]), a.back.visible && c.push(p[1], p[3]), a.left.visible && c.push(p[0], p[1]), a.right.visible && c.push(p[2], p[3])), c = l(c, this.chart, !1)), i.renderer.toLineSegments(c);
    }
    function v(t, e) {
      let {
        chart: i,
      ...
      if (this.categories && i.frameShapes && i.is3d() && s && e && e.label) {
        ...
        return f?.label?.xy && (a = h({
          ...
          y: f.label.xy.y,
          z: null
        }, d, d.vd)), u && u.label && u.label.xy && (n = h({
          x: u.label.xy.x,
          y: u.label.xy.y,
          z: null
        }, d, d.vd)), t = h(t = {
          ...
          y: e.label.xy.y,
          z: null
        }, d, d.vd), Math.abs(a ? t.x - a.x : n ? n.x - t.x : l.x - p.x);
      }
    ...
    class S {
      static compose(e, i) {
        if (o.compose(i), !e.keepProps.includes("axis3D")) {
          d(!0, a.xAxis, t), e.keepProps.push("axis3D"), c(e, "init", z), c(e, "afterSetOptions", f), c(e, "drawCrosshair", u);
          let i = e.prototype;
          y(i, "getLinePath", b), y(i, "getPlotBandPath", g), y(i, "getPlotLinePath", m), y(i, "getSlotWidth", v), y(i, "getTitlePosition", M);
        }
      }
      constructor(t) {
        this.axis = t;
      ...
      fix3dPosition(t, e) {
        ...
        let o = n * s.options.chart.options3d.alpha,
          r = n * s.options.chart.options3d.beta,
          a = x(e && i.options.title.position3d, i.options.labels.position3d),
          h = x(e && i.options.title.skew3d, i.options.labels.skew3d),
          c = s.chart3d.frame3d,
          d = s.plotLeft,
          y = s.plotWidth + d,
          f = s.plotTop,
        ...
        if (t = i.axis3D.swapZ({
          ...
          if (i.opposite) {
            ...
            b = t.y - f, t.x = c.axes.z.top.x, t.y = c.axes.z.top.y, g = c.axes.z.top.xDir, v = !c.top.frontFacing;
          } else {
            if (null === c.axes.z.bottom) return {};
            b = t.y - u, t.x = c.axes.z.bottom.x, t.y = c.axes.z.bottom.y, g = c.axes.z.bottom.xDir, v = !c.bottom.frontFacing;
          }
        } else if (i.horiz) {
          if (i.opposite) {
            if (null === c.axes.x.top) return {};
            b = t.y - f, t.y = c.axes.x.top.y, t.z = c.axes.x.top.z, g = c.axes.x.top.xDir, v = !c.top.frontFacing;
          } else {
            if (null === c.axes.x.bottom) return {};
            b = t.y - u, t.y = c.axes.x.bottom.y, t.z = c.axes.x.bottom.z, g = c.axes.x.bottom.xDir, v = !c.bottom.frontFacing;
          }
        } else if (i.opposite) {
          if (null === c.axes.y.right) return {};
          z = t.x - y, t.x = c.axes.y.right.x, t.z = c.axes.y.right.z, g = {
          ...
          z = t.x - d, t.x = c.axes.y.left.x, t.z = c.axes.y.left.z, g = c.axes.y.left.xDir;
        }
        if ("chart" === a) ;else if ("flap" === a) {
          if (i.horiz) {
            let t = Math.sin(o),
              e = Math.cos(o);
        ...
        if (h) {
          ...
          M.matrix = [e[1].x - e[0].x, e[1].y - e[0].y, e[2].x - e[0].x, e[2].y - e[0].y, M.x, M.y], M.matrix[4] -= M.x * M.matrix[0] + M.y * M.matrix[2], M.matrix[5] -= M.x * M.matrix[1] + M.y * M.matrix[3];
        }
        return M;
      }
      swapZ(t, e) {
    ...
    class d extends i {
      ...
      translate3dPoints() {
        ...
        i.zPadding = c * (s.depth || 0 + (s.groupZPadding || 1)), i.data.forEach(t => {
          a && a.translate ? (e = a.logarithmic && a.val2lin ? a.val2lin(t.z) : t.z, t.plotZ = a.translate(e), t.isInside = !!t.isInside && e >= a.min && e <= a.max) : t.plotZ = i.zPadding, t.axisXpos = t.plotX, t.axisYpos = t.plotY, t.axisZpos = t.plotZ, n.push({
            x: t.plotX,
            y: t.plotY,
            z: t.plotZ
          }), h.push(t.plotX || 0);
        ...
        let d = r(n, o, !0);
        i.data.forEach((e, i) => {
          t = d[i], e.plotX = t.x, e.plotY = t.y, e.plotZ = t.z;
        });
      }
    }
    ...
    return function (t) {
      ...
      function S(t) {
        let e = t.x || 0,
          ...
          a = t.depth || 0,
          n = h[this.chartIndex],
          l = n.options.chart.options3d.alpha,
          p = [],
          x,
          y = 0,
          f = [{
        ...
        let u = t => 0 === o && t > 1 && t < 6 ? {
          ...
          b = (t, e, i) => {
            let s = t.map(z),
              ...
              a = e.map(u),
              n = [[], -1];
            return 0 > d(s) ? n = [s, 0] : 0 > d(o) ? n = [o, 1] : i && (p.push(i), n = 0 > d(r) ? [s, 0] : 0 > d(a) ? [o, 1] : [s, 0]), n;
          },
          ...
          A = x[1];
        return 1 === A ? y += 1e6 * (n.plotWidth - e) : A || (y += 1e6 * e), y += 10 * (!M || l >= 0 && l <= 180 || l < 360 && l > 357.5 ? n.plotHeight - i : 10 + i), 1 === m ? y += 100 * s : m || (y += 100 * (1e3 - s)), {
      ...
      function P(t) {
        let e = t.x || 0,
          ...
          S = n * Math.sin(l),
          A = [["M", e + y * p, i + f * c]];
        (A = A.concat(v(e, i, y, f, s, o, 0, 0))).push(["L", e + u * d, i + m * x]), (A = A.concat(v(e, i, u, m, o, s, 0, 0))).push(["Z"]);
    ...
    class p extends t {
      ...
      static compose(t) {
        ...
        e.addZAxis || (s.zAxis = r(s.xAxis, {
          offset: 0,
          lineWidth: 0
        }), e.addZAxis = l, e.collectionsWithInit.zAxis = [e.addZAxis], e.collectionsWithUpdate.push("zAxis"), o(t, "afterGetAxes", h));
      }
      init(t, e) {
      ...
      getSeriesExtremes() {
        this.hasVisibleSeries = !1, this.dataMin = this.dataMax = this.ignoreMinPadding = this.ignoreMaxPadding = void 0, this.stacking && this.stacking.buildStacks(), this.series.forEach(t => {
          if (t.reserveSpace()) {
            ...
            let i = t.zData;
            i.length && (this.dataMin = Math.min(a(this.dataMin, i[0]), Math.min.apply(null, i)), this.dataMax = Math.max(a(this.dataMax, i[0]), Math.max.apply(null, i)));
          }
        });
      }
      setAxisSize() {
    ...
    function p() {
      let t = this.chart,
        ...
        r = this.borderWidth % 2 ? .5 : 0,
        n;
      for (let l of (t.inverted && !this.yAxis.reversed && (r *= -1), !1 !== e.grouping && (s = 0), s += e.groupZPadding || 1, this.points)) if (l.outside3dPlot = null, null !== l.y) {
        let e;
        let h = a({
            x: 0,
            y: 0,
          ...
          p = [["x", "width"], ["y", "height"]],
          c = l.tooltipPos;
        for (let t of p) if ((e = h[t[0]] - r) < 0 && (h[t[1]] += h[t[0]] + r, h[t[0]] = -r, e = 0), e + h[t[1]] > this[t[0] + "Axis"].len && 0 !== h[t[1]] && (h[t[1]] = this[t[0] + "Axis"].len - h[t[0]]), 0 !== h[t[1]] && (h[t[0]] >= this[t[0] + "Axis"].len || h[t[0]] + h[t[1]] <= r)) {
          for (let t in h) h[t] = "y" === t ? -9999 : 0;
          l.outside3dPlot = !0;
        }
        if ("roundedRect" === l.shapeType && (l.shapeType = "cuboid"), l.shapeArgs = a(h, {
          z: s,
          depth: i,
          insidePlotArea: !0
        }), n = {
          ...
          y: h.y,
          z: s + i / 2
        }, t.inverted && (n.x = h.height, n.y = l.clientX || 0), l.axisXpos = n.x, l.axisYpos = n.y, l.axisZpos = n.z, l.plot3d = o([n], t, !0, !1)[0], c) {
          let e = o([{
            x: c[0],
            y: c[1],
            z: s + i / 2
    ...
    function c() {
      if (this.chart.is3d()) {
        ...
        if (!(void 0 !== e && !e)) {
          ...
          o = 10 * (r.totalStacks - r[a].position) + (s ? e : -e), this.xAxis.reversed || (o = 10 * r.totalStacks - o);
        }
    ...
    function x(t) {
      if (this.chart.is3d()) {
        ...
        if (e) for (let t of this.points) null === t.y || (t.height = t.shapeArgs.height, t.shapey = t.shapeArgs.y, t.shapeArgs.height = 1, s || (t.stackY ? t.shapeArgs.y = t.plotY + i.translate(t.stackY) : t.shapeArgs.y = t.plotY + (t.negative ? -t.height : t.height)));else {
    ...
    function f(t) {
      let e = t.apply(this, [].slice.call(arguments, 1));
      return this.chart.is3d && this.chart.is3d() && (e.stroke = this.options.edgeColor || e.fill, e["stroke-width"] = n(this.options.edgeWidth, 1)), e;
    }
    function u(t, e, i) {
    ...
    function z(t, e) {
      if (this.chart.is3d()) for (let t of this.points) t.visible = t.options.visible = e = void 0 === e ? !n(this.visible, t.visible) : e, this.options.data[this.data.indexOf(t)] = t.options, t.graphic && t.graphic.attr({
    ...
    function g(t, e, i, s, r) {
      ...
      if (s.outside3dPlot = e.outside3dPlot, a.is3d() && this.is("column")) {
        ...
        a.inverted && (i && (r.width = 0, p.x += e.shapeArgs.height / 2), l.alpha >= 90 && l.alpha <= 270 && (p.y += e.shapeArgs.width)), p = o([p], a, !0, !1)[0], r.x = p.x - h, r.y = e.outside3dPlot ? -9e9 : p.y;
      }
    ...
    function v(t, e) {
      ...
      if (s.is3d() && this.base) {
        ...
        if (e && "column" === e.type) {
          ...
          s.inverted && (i.width = 0, a.alpha >= 90 && a.alpha <= 270 && (t.y += r)), t = o([t], s, !0, !1)[0], i.x = t.x - r / 2, i.y = t.y;
        }
      }
      return i;
    }
    return {
      compose: function (t, e) {
        if (l(s, "Column3D")) {
          ...
          if (h(i, "alignDataLabel", g), h(i, "justifyDataLabel", m), h(s, "getStackBox", v), o) {
            let t = o.prototype,
              e = t.pointClass.prototype;
            t.translate3dPoints = () => void 0, t.translate3dShapes = p, r(t, "afterInit", c), h(e, "hasNewShapeType", d), h(t, "animate", x), h(t, "plotGroup", y), h(t, "pointAttribs", f), h(t, "setState", u), h(t, "setVisible", z), h(t, "translate", b);
          }
          if (a) {
            let t = a.prototype;
            h(t.pointClass.prototype, "hasNewShapeType", d), h(t, "plotGroup", y), h(t, "pointAttribs", f), h(t, "setState", u), h(t, "setVisible", z);
          }
        }
      }
    };
    ...
    class p extends a {
      ...
      animate(t) {
        if (this.chart.is3d()) {
          let e = this.center,
            ...
            r;
          !0 === o && (o = {}), t ? (i.oldtranslateX = l(i.oldtranslateX, i.translateX), i.oldtranslateY = l(i.oldtranslateY, i.translateY), r = {
            translateX: e[0],
            translateY: e[1],
            scaleX: .001,
            scaleY: .001
      ...
      pointAttribs(t) {
        let e = super.pointAttribs.apply(this, arguments),
          i = this.options;
        return this.chart.is3d() && !this.chart.styledMode && (e.stroke = i.edgeColor || t.color || this.color, e["stroke-width"] = l(i.edgeWidth, 1)), e;
      }
      translate() {
        ...
        for (let i of (a += e / 2, !1 !== t.grouping && (a = 0), this.points)) {
          let n = i.shapeArgs;
          i.shapeType = "arc3d", n.z = a, n.depth = .75 * e, n.alpha = s, n.beta = o, n.center = this.center;
    ...
    return i.compose(t.seriesTypes.area), s.compose(t.Axis, t.Tick), e.compose(t.Chart, t.Fx), h.compose(t.Series, a), p.compose(t.Series), r.compose(t.Series), n.compose(o.getRendererType()), l.compose(t.Chart), t;
  });
});
...
//# sourceMappingURL=default-node_modules_highcharts_highcharts-3d_js-node_modules_highcharts-angular_fesm2020_hig-258897.js.map