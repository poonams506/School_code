...
{
    public class FeePaymentHistorySelectDto
    {
        ...
        public List<FeeParticularsSelectDto> FeeParticularsSelectList { get; set; } = new List<FeeParticularsSelectDto>();
    }

    public class FeeParticularsSelectDto
    {
