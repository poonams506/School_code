(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["src_app_pages_parentApp_parents_parents_module_ts"],{

/***/ 51871:
/*!*******************************************************************!*\
  !*** ./src/app/pages/parentApp/parents/parents-routing.module.ts ***!
  \*******************************************************************/
...
/* harmony export */   ParentsRoutingModule: () => (/* binding */ ParentsRoutingModule)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 24398);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37580);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 95072);
/* harmony import */ var _parents_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./parents.component */ 93327);
...
const routes = [{
  path: '',
  component: _parents_component__WEBPACK_IMPORTED_MODULE_0__.ParentsComponent
}];
let ParentsRoutingModule = class ParentsRoutingModule {};
ParentsRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
...
/***/ 93327:
/*!**************************************************************!*\
  !*** ./src/app/pages/parentApp/parents/parents.component.ts ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ParentsComponent: () => (/* binding */ ParentsComponent)
/* harmony export */ });
...
/* harmony import */ var _parents_component_html_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./parents.component.html?ngResource */ 44785);
/* harmony import */ var _parents_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./parents.component.scss?ngResource */ 41039);
/* harmony import */ var _parents_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_parents_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__);
...
let ParentsComponent = class ParentsComponent {
  constructor(formBuilder, toastService, studentProfileService, userService, masterService, router, commonMethod, httpClient, elementRef, actionSheetController) {
    ...
    this.isFatherSubmitted = false;
    this.isMotherSubmitted = false;
    this.isGuardianSubmitted = false;
    this.fatherFullName = '';
    this.motherFullName = '';
    this.guardianFullName = '';
    this.fatherProfileImageUrl = '';
    this.motherProfileImageUrl = '';
  ...
  updateFatherProfilePicture() {
    ...
    return (0,_Users_admin_Documents_schoolhub_asm_code_ParentAppUI_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this.fatherProfileImageUrl = image.dataUrl;
      ...
      _this.fatherFiles.push(fileToInsert);
      _this.compressImage(fileToInsert).then(compressedFile => {
        _this.fatherFiles.push(compressedFile);
      });
    })();
  }
  // Update profile picture
  updateMotherProfilePicture() {
    var _this2 = this;
    return (0,_Users_admin_Documents_schoolhub_asm_code_ParentAppUI_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this2.motherFiles = [];
      const status = yield _capacitor_camera__WEBPACK_IMPORTED_MODULE_3__.Camera.requestPermissions();
      ...
      _this2.motherProfileImageUrl = image.dataUrl;
      ...
      _this2.motherFiles.push(fileToInsert);
      _this2.compressImage(fileToInsert).then(compressedFile => {
        _this2.motherFiles.push(compressedFile);
      });
    })();
  }
  // Update profile picture
  updateGuardianProfilePicture() {
    ...
    return (0,_Users_admin_Documents_schoolhub_asm_code_ParentAppUI_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this3.guardianProfileImageUrl = image.dataUrl;
      let contentType = _this3.getFileContentTypeFromDataURL(image.dataUrl);
      let fileExtension = _this3.getFileExtensionFromDataURL(image.dataUrl);
      let uniqueFileName = _this3.generateUniqueId();
      let fileToInsert = yield _this3.base64ToBlob(image.dataUrl, contentType, uniqueFileName + '.' + fileExtension, 1);
      _this3.guardianFiles.push(fileToInsert);
      _this3.compressImage(fileToInsert).then(compressedFile => {
        _this3.guardianFiles.push(compressedFile);
      });
    })();
  }
  getMasterDropdownData() {
    this.fatherProfileForm.get('countryId')?.valueChanges.subscribe(countryId => {
    ...
    this.guardianProfileForm.get('stateId')?.valueChanges.subscribe(stateId => {
      this.districtGuardianFilteredDropdownList = this.districtDropdownList.filter(district => district.stateId === parseInt(stateId));
      this.guardianProfileForm.get('districtId')?.setValue(null);
      this.guardianProfileForm.get('talukaId')?.setValue(null);
    });
    this.guardianProfileForm.get('districtId')?.valueChanges.subscribe(districtId => {
      this.talukaGuardianFilteredDropdownList = this.talukaDropdownList.filter(taluka => taluka.districtId === parseInt(districtId));
      this.guardianProfileForm.get('talukaId')?.setValue(null);
    });
    (0,rxjs__WEBPACK_IMPORTED_MODULE_10__.forkJoin)([this.masterService.getAddressMasterData(), this.studentProfileService.getParentProfile(this.userService.CurrentSiblingId)]).subscribe(result => {
      ...
      if (fatherDetail.profileBase64Image != undefined && fatherDetail.profileBase64Image != null) {
        ...
        this.base64ToBlob(fatherDetail.profileBase64Image, fatherDetail.profileImageContentType, fatherDetail.profileImageURL, -1).then(file => {
          this.fatherFiles = [];
      ...
      if (motherDetail.profileBase64Image != undefined && motherDetail.profileBase64Image != null) {
        ...
        this.base64ToBlob(motherDetail.profileBase64Image, motherDetail.profileImageContentType, motherDetail.profileImageURL, -1).then(file => {
          this.motherFiles = [];
      ...
      if (guardianDetail.profileBase64Image != undefined && guardianDetail.profileBase64Image != null) {
        ...
        this.base64ToBlob(guardianDetail.profileBase64Image, guardianDetail.profileImageContentType, guardianDetail.profileImageURL, -1).then(file => {
          this.guardianFiles = [];
  ...
  submitFather() {
    ...
    if (this.fatherProfileForm.valid) {
      ...
      this.httpClient.post(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_8__.environment.API_BASE_URL}/api/StudentProfile/ParentProfileUpdate`, formData).subscribe(result => {
  ...
  get ff() {
    return this.fatherProfileForm.controls;
  }
  get fm() {
    return this.motherProfileForm.controls;
  }
  get fg() {
    return this.guardianProfileForm.controls;
  }
...
ParentsComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_15__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_13__.Component)({
  selector: 'app-parents',
  template: _parents_component_html_ngResource__WEBPACK_IMPORTED_MODULE_1__,
  styles: [(_parents_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_2___default())]
})], ParentsComponent);
...
/***/ 86414:
/*!***********************************************************!*\
  !*** ./src/app/pages/parentApp/parents/parents.module.ts ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ParentsModule: () => (/* binding */ ParentsModule)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tslib */ 24398);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 37580);
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common */ 60316);
/* harmony import */ var _parents_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./parents-routing.module */ 51871);
...
/* harmony import */ var _parents_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./parents.component */ 93327);
...
ParentsModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
  declarations: [_parents_component__WEBPACK_IMPORTED_MODULE_1__.ParentsComponent],
  imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _parents_routing_module__WEBPACK_IMPORTED_MODULE_0__.ParentsRoutingModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.ReactiveFormsModule]
})], ParentsModule);
...
/***/ 41039:
/*!***************************************************************************!*\
  !*** ./src/app/pages/parentApp/parents/parents.component.scss?ngResource ***!
  \***************************************************************************/
...
/***/ 44785:
/*!***************************************************************************!*\
  !*** ./src/app/pages/parentApp/parents/parents.component.html?ngResource ***!
  \***************************************************************************/
/***/ ((module) => {
...
//# sourceMappingURL=src_app_pages_parentApp_parents_parents_module_ts.js.map