(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["src_app_pages_teacherApp_timetable_timetable_module_ts"],{

/***/ 53353:
/*!************************************************************************!*\
  !*** ./src/app/pages/teacherApp/timetable/timetable-routing.module.ts ***!
  \************************************************************************/
...
/* harmony import */ var _timetable_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./timetable.component */ 51805);
...
/***/ 51805:
/*!*******************************************************************!*\
  !*** ./src/app/pages/teacherApp/timetable/timetable.component.ts ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _timetable_component_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./timetable.component.html?ngResource */ 25283);
/* harmony import */ var _timetable_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./timetable.component.scss?ngResource */ 22267);
...
let TimetableComponent = class TimetableComponent {
  ...
  ionViewDidEnter() {
    ...
    this.lstWeek = [{
      id: 1,
      value: 'Sun',
      isSelected: this.currentDate.day() == 7
    }, {
      id: 2,
      value: 'Mon',
      isSelected: this.currentDate.day() == 1
    }, {
      id: 3,
      value: 'Tue',
      isSelected: this.currentDate.day() == 2
    }, {
      id: 4,
      value: 'Wed',
      isSelected: this.currentDate.day() == 3
    }, {
      id: 5,
      value: 'Thur',
      isSelected: this.currentDate.day() == 4
    }, {
      id: 6,
      value: 'Fri',
      isSelected: this.currentDate.day() == 5
    }, {
      id: 7,
      value: 'Sat',
      isSelected: this.currentDate.day() == 6
    }];
  ...
  loadTeacherPeriodList() {
    ...
    this.classTimeTableService.getTeacherClassTimeTable(requestWrapper).subscribe(result => {
        ...
        result.classTimeTable.forEach(classTimeData => {
          classTimeData.lstClassTimeTableRow.forEach(row => {
            row.lstClassTimeTableColumn.forEach(column => {
              ...
              this.teacherPeriodListCurrentDay = this.teacherPeriodList.filter(x => x.Day == this.lstWeek.filter(y => y.isSelected)[0].id).sort(this.compare);
            });
          });
        });
      }
...
/***/ 14240:
/*!****************************************************************!*\
  !*** ./src/app/pages/teacherApp/timetable/timetable.module.ts ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _timetable_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./timetable-routing.module */ 53353);
/* harmony import */ var _timetable_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./timetable.component */ 51805);
...
/***/ 22267:
/*!********************************************************************************!*\
  !*** ./src/app/pages/teacherApp/timetable/timetable.component.scss?ngResource ***!
  \********************************************************************************/
