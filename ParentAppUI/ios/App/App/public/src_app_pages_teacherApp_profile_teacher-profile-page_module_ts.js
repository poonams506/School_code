(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["src_app_pages_teacherApp_profile_teacher-profile-page_module_ts"],{

/***/ 53420:
/*!*********************************************************************************!*\
  !*** ./src/app/pages/teacherApp/profile/teacher-profile-page-routing.module.ts ***!
  \*********************************************************************************/
...
/* harmony export */   TeacherProfilePageRoutingModule: () => (/* binding */ TeacherProfilePageRoutingModule)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 24398);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37580);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 95072);
/* harmony import */ var _teacher_profile_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./teacher-profile.page */ 13258);
...
const routes = [{
  path: '',
  component: _teacher_profile_page__WEBPACK_IMPORTED_MODULE_0__.TeacherProfilePage
}];
let TeacherProfilePageRoutingModule = class TeacherProfilePageRoutingModule {};
TeacherProfilePageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
...
/***/ 8941:
/*!*************************************************************************!*\
  !*** ./src/app/pages/teacherApp/profile/teacher-profile-page.module.ts ***!
  \*************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   TeacherProfilePageModule: () => (/* binding */ TeacherProfilePageModule)
/* harmony export */ });
...
/* harmony import */ var _teacher_profile_page_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./teacher-profile-page-routing.module */ 53420);
/* harmony import */ var _teacher_profile_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./teacher-profile.page */ 13258);
...
let TeacherProfilePageModule = class TeacherProfilePageModule {};
TeacherProfilePageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
  imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _teacher_profile_page_routing_module__WEBPACK_IMPORTED_MODULE_0__.TeacherProfilePageRoutingModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.ReactiveFormsModule],
  declarations: [_teacher_profile_page__WEBPACK_IMPORTED_MODULE_1__.TeacherProfilePage]
...
/***/ 13258:
/*!******************************************************************!*\
  !*** ./src/app/pages/teacherApp/profile/teacher-profile.page.ts ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   TeacherProfilePage: () => (/* binding */ TeacherProfilePage)
/* harmony export */ });
...
/* harmony import */ var _teacher_profile_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./teacher-profile.page.html?ngResource */ 62314);
/* harmony import */ var _teacher_profile_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./teacher-profile.page.scss?ngResource */ 92232);
/* harmony import */ var _teacher_profile_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_teacher_profile_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__);
...
let TeacherProfilePage = class TeacherProfilePage {
  constructor(formBuilder, toastService, teacherProfileService, userService, masterService, router, commonMethod, httpClient) {
  ...
  updateProfilePicture() {
    ...
    return (0,_Users_admin_Documents_schoolhub_asm_code_ParentAppUI_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this.teacherProfileImageUrl = image.dataUrl;
  ...
  getMasterDropdownData() {
    this.teacherProfileForm.get('countryId')?.valueChanges.subscribe(countryId => {
    ...
    this.teacherProfileForm.get('stateId')?.valueChanges.subscribe(stateId => {
      this.districtFilteredDropdownList = this.districtDropdownList.filter(district => district.stateId === parseInt(stateId));
      this.teacherProfileForm.get('districtId')?.setValue(null);
      this.teacherProfileForm.get('talukaId')?.setValue(null);
    });
    this.teacherProfileForm.get('districtId')?.valueChanges.subscribe(districtId => {
    ...
    this.userService.getUserIdByRole().subscribe(userIdResult => {
      (0,rxjs__WEBPACK_IMPORTED_MODULE_10__.forkJoin)([this.masterService.getAddressMasterData(), this.teacherProfileService.getTeacherProfile(userIdResult)]).subscribe(result => {
        ...
        if (teacherDetail.profileBase64Image != undefined && teacherDetail.profileBase64Image != null) {
          ...
          this.base64ToBlob(teacherDetail.profileBase64Image, teacherDetail.profileImageContentType, teacherDetail.profileImageURL, -1).then(file => {
            this.files = [];
  ...
  submit() {
    ...
    if (this.teacherProfileForm.valid) {
      ...
      this.httpClient.post(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_8__.environment.API_BASE_URL}/api/TeacherProfile/TeacherProfileUpdate`, formData).subscribe(result => {
  ...
  get f() {
    return this.teacherProfileForm.controls;
  }
  ...
  static #_ = this.ctorParameters = () => [{
    ...
    type: src_app_services_school_api_service__WEBPACK_IMPORTED_MODULE_5__.TeacherProfileServiceProxy
  }, {
...
TeacherProfilePage = (0,tslib__WEBPACK_IMPORTED_MODULE_13__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_14__.Component)({
  selector: 'app-edit',
  template: _teacher_profile_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__,
  styles: [(_teacher_profile_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2___default())]
})], TeacherProfilePage);
...
/***/ 92232:
/*!*******************************************************************************!*\
  !*** ./src/app/pages/teacherApp/profile/teacher-profile.page.scss?ngResource ***!
  \*******************************************************************************/
