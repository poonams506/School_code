...
namespace SchoolApiApplication.BusinessLayer.Interfaces.TransportFeePaymentModule
{
    public interface ITransportFeePaymentService
    {
        ...
        public Task<TransportPaymentReportDaywiseDto> GetDayWiseTranportPaymentReport(DateTime StartDate, DateTime EndDate);
        #endregion
    }
}
